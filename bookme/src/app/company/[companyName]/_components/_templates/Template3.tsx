    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 px-4 sm:px-6 lg:px-8 py-12 max-w-7xl mx-auto -mt-18 z-20">
        ...
        <div className="sticky top-6 h-fit space-y-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:p-8">
          ...
          <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 hover:shadow-lg shadow-blue-500/20 text-center font-semibold relative overflow-hidden group mt-4">
