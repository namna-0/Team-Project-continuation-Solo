        ...
        <div className="bg-white w-full rounded-2xl p-4 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-4 gap-3 justify-between">
                <div className="relative">
                    <Button variant={"outline"} className="w-full h-full rounded-3xl flex flex-col items-center justify-center">
                    ...
                    company?.companyImages.map((image, index) => {
                        return (
                            <div key={index} className="w-full h-full relative">
                                <CompanyImageCard image={image} index={index} newImage={newImage} />
                            </div>
                        )
                    })
                )}
