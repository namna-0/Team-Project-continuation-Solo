...
export const EmployeeDeleteButton = ({ employeeId, employeeName, employeeProfilePicture }: Props) => {
                ...
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle className="w-full flex flex-col items-center">
                            <div className="flex gap-1">Ажилтан{" "}
                                <span className="text-red-500">{employeeName}</span>
                                -г устгах гэж байна.
                            </div>
                    ...
                    <div className="flex justify-center">
                        <img src={employeeProfilePicture} className="w-[300px] h-[250px] rounded-2xl" />
                    </div>
                    <DialogFooter>
